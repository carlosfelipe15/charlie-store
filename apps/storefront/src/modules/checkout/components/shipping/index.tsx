...
const Shipping: React.FC<ShippingProps> = ({
  ...
  const methodName = cart.shipping_methods?.at(-1)?.name

  return (
    <RodiCheckoutSection
      title="Método de envío"
      subtitle={
        !isOpen && hasShipping && methodName
          ? methodName
          : undefined
      }
      done={hasShipping && !isOpen}
      active={isOpen}
      onEdit={
        hasShipping &&
        ...
        <>
          <div className="grid">
            <div className="flex flex-col">
              ...
              <span className="mb-4 text-rm-ink-2 text-sm block">
                ...
                {hasPickupOptions && (
                  ...
                  >
                    <Radio
                      ...
                      className={clx(
                        "flex items-center justify-between text-sm cursor-pointer py-3.5 border border-rm-line rounded-rm-lg px-4 mb-2 hover:border-rm-ink bg-rm-paper",
                        {
                          "border-rm-ink bg-rm-cream":
                    ...
                    {_pickupMethods?.map((option) => {
                      return (
                        <Radio
                          ...
                          data-testid="delivery-option-radio"
                          className={clx(
                            "flex items-center justify-between text-sm cursor-pointer py-3.5 border border-rm-line rounded-rm-lg px-4 mb-2 bg-rm-paper",
                            {
                              "border-rm-ink bg-rm-cream":
                                option.id === shippingMethodId,
                              "opacity-50 cursor-not-allowed":
