...
> Documento de referencia técnica, no un plan de fase ni una auditoría puntual — a diferencia de `.context/reports/`, este archivo está pensado para consultarse cuando se decida retomar el tema, y debería actualizarse si el código cambia (no archivar sin más). Complementa a [`plans/2026-07-19/plan-zonas-entrega-provincia-municipio.md`](./plans/2026-07-19/plan-zonas-entrega-provincia-municipio.md) (el plan de fases del feature de zonas, ya completado y archivado) y a [`reports/zonas-entrega-direcciones-incongruencias-2026-07-22.md`](./reports/zonas-entrega-direcciones-incongruencias-2026-07-22.md) (la auditoría que originó este documento). Escrito el 2026-07-22 por Claude, a pedido de Carlos.
>
